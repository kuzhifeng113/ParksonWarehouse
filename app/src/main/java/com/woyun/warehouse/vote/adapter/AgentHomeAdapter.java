 ...
 *  代理 权益
 */
public class AgentHomeAdapter extends RecyclerView.Adapter<AgentHomeAdapter.MyViewHolder> {
    ...
    public AgentHomeAdapter(Context context, List<VoteHomeBean> dataList, boolean isVip) {
