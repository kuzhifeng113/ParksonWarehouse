 ...
 *  Vip 2.0 权益
 */
public class VipAgentAdapter extends RecyclerView.Adapter<VipAgentAdapter.MyViewHolder> {
    private Context context;
    private List<ZuanQianBean.AgentListBean> dataList;
    ...
    public VipAgentAdapter(Context context, List<ZuanQianBean.AgentListBean> dataList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ZuanQianBean.AgentListBean voteBean = dataList.get(position);
