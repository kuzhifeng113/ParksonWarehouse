 ...
 *  当前期数投票适配
 */
public class VoteHomeAdapter extends RecyclerView.Adapter<VoteHomeAdapter.MyViewHolder> {
    private static final String TAG = "VoteHomeAdapter";
    ...
    public VoteHomeAdapter(Context context, List<VoteHomeBean.GoodsListBean> dataList,boolean isVip) {
...
//        Log.e(TAG, "onBindViewHolder: xiang"+voteBean.getWantNum() );
//        Log.e(TAG, "onBindViewHolder: total"+voteBean.getTotalNum() );
        ...
        if(voteBean.isIsVote()){//已投票
            holder.btn_i_want.setText("已预购");
            holder.btn_i_want.setClickable(false);
            holder.btn_i_want.setEnabled(false);
            holder.btn_i_want.setBackgroundResource(R.drawable.shape_vote_no_want);
        }else{
            holder.btn_i_want.setText("预购");
            holder.btn_i_want.setClickable(true);
            holder.btn_i_want.setEnabled(true);
            holder.btn_i_want.setBackgroundResource(R.drawable.shape_vote_want);
        }
        if(position==0){
    ...
    public int getItemCount() {
     ...
     class MyViewHolder extends RecyclerView.ViewHolder {
        ImageView round_img;
        TextView tvName,tvVipPrice,tvPrice,tv_want_num,tv_no;
        Button btn_i_want;
