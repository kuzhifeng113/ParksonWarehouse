 ...
 * 商品分类2.0fragment
 */
public class HostFragmentThree extends BaseFragment {
    ...
    private CategoryGoodsAdapterOne goodsAdapterOne;

    //回调用来接收参数
    public static HostFragmentThree getInitUrl(int gc_id) {

        HostFragmentThree hostFragment = new HostFragmentThree();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_host_all_two, container, false);
        ...
        goodsAdapterOne = new CategoryGoodsAdapterOne(getActivity(), finalData,pager,packListBeans,listDataTwo);
