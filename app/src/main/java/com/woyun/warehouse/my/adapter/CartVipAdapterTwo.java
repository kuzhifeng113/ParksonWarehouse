 ...
 *  Vip 2.0 礼包 购物车适配
 */
public class CartVipAdapterTwo extends RecyclerView.Adapter<CartVipAdapterTwo.MyViewHolder> {
    private static final String TAG = "CartVipAdapter";
    private Context context;
    private List<VipCenterTwoBean.GoodsListBean> dataList;
    ...
    public CartVipAdapterTwo(Context context, List<VipCenterTwoBean.GoodsListBean> dataList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final VipCenterTwoBean.GoodsListBean entityBean = dataList.get(position);
