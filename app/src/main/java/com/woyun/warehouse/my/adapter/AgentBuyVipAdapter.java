 ...
 *  代理开通Vip 礼包 适配
 */
public class AgentBuyVipAdapter extends RecyclerView.Adapter<AgentBuyVipAdapter.MyViewHolder> {
    private static final String TAG = "AgentOpenAdapter";
    private Context context;
    private List<AgentBuyVipBean.GoodsListBean> dataList;
    ...
    public AgentBuyVipAdapter(Context context, List<AgentBuyVipBean.GoodsListBean> dataList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        final AgentBuyVipBean.GoodsListBean entityBean = dataList.get(position);
