...
import com.woyun.warehouse.my.activity.FeedBackActivity;
...
public class KeFuWebViewActivity extends BaseActivity  {
    ...
    private TextView tvAdvice;//反馈

    private String webUrl;
    private boolean isProblem;//是否从问题与反馈进来的
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        isProblem=getIntent().getBooleanExtra("isPro",false);
        if(isProblem){
...
//                .setWebLayout(new WebLayout(this))
        ...
        tvAdvice.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent= new Intent(KeFuWebViewActivity.this, FeedBackActivity.class);
