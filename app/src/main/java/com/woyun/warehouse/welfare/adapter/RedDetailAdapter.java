package com.woyun.warehouse.welfare.adapter;
 ...
 *红包明细 适配
 */
public class RedDetailAdapter extends RecyclerView.Adapter<RedDetailAdapter.MyViewHolder> {
    private Context context;
    private List<RedPackDetailBean.ContentBean> dataList;
    ...
    public RedDetailAdapter(Context context, List<RedPackDetailBean.ContentBean> dataList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_redpack_detail, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        RedPackDetailBean.ContentBean voteBean = dataList.get(position);
