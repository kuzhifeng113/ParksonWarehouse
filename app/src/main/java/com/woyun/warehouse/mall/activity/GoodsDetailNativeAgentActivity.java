 ...
 * 商品详情(代理 )-原生
 */
public class GoodsDetailNativeAgentActivity extends BaseActivity implements CommonPopupWindow.ViewInterface, WbShareCallback {
...
//                cehckISVip();
                SPUtils.getInstance(GoodsDetailNativeAgentActivity.this).put(Constant.USER_IS_AGENT, true);
                ToastUtils.getInstanc(GoodsDetailNativeAgentActivity.this).showToast("支付成功！！！");
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        MyApplication.getInstance().addActivity(GoodsDetailNativeAgentActivity.this);

        mContext = GoodsDetailNativeAgentActivity.this;
        mIUiListener = new ShareQQListener();
        iwxApi = WXAPIFactory.createWXAPI(GoodsDetailNativeAgentActivity.this, Constant.WX_APP_ID);
        iwxApi.registerApp(Constant.WX_APP_ID);
        mTencent = Tencent.createInstance(Constant.QQ_APP_ID, getApplicationContext());
        //微博
        shareHandler = new WbShareHandler(GoodsDetailNativeAgentActivity.this);
...
//                    Log.e(TAG, "onAdded: unitPrice" +sku.getVipPrice());
    ...
    private void getData(int goodsID) {
        ...
        try {
            ...
            RequestInterface.goodsPrefix(GoodsDetailNativeAgentActivity.this, params, TAG, ReqConstance.I_GOODS_DETAIL, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    ModelLoading.getInstance(GoodsDetailNativeAgentActivity.this).closeLoading();
                    tokenTimeLimit(GoodsDetailNativeAgentActivity.this, code);
                    if (code == 0) {
...
//                            Log.e(TAG, "requestSuccess: " + jsonResult);
                        ...
                        ToastUtils.getInstanc(GoodsDetailNativeAgentActivity.this).showToast(msg);
                    }
                }
                ...
                public void requestError(String s, int i) {
                    ...
                    ToastUtils.getInstanc(GoodsDetailNativeAgentActivity.this).showToast(s);
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
...
//        }
        ...
        nativeContentAdapter = new NativeContentAdapter(GoodsDetailNativeAgentActivity.this, contentListBeanList);
        recyclerView.setAdapter(nativeContentAdapter);

        nativeViewPageAdapter = new NativeViewPageAdapter(GoodsDetailNativeAgentActivity.this, resListBeanList);
        ...
        nativeViewPageAdapter.setOnItemClickListener(new NativeViewPageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int index) {
                ...
                startActivity(toLook, ActivityOptions.makeSceneTransitionAnimation(GoodsDetailNativeAgentActivity.this).toBundle());
            }
        });
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.img_kf://客服
                ...
                //以下信息是可选
                info.put(UdeskConst.UdeskUserInfo.NICK_NAME, (String) SPUtils.getInstance(GoodsDetailNativeAgentActivity.this).get(Constant.USER_NICK_NAME, ""));//昵称
                info.put(UdeskConst.UdeskUserInfo.CELLPHONE, (String) SPUtils.getInstance(GoodsDetailNativeAgentActivity.this).get(Constant.USER_MOBILE, ""));//手机
...
//                startActivity(kefu);
            ...
            case R.id.img_goods_buy://购买
                ...
                if (!isVip) {
                    ToastUtils.getInstanc(GoodsDetailNativeAgentActivity.this).showToast("请先开通会员~");
                    return;
                }
                showDilog(2);
                break;
...
//                showSharePop();
            ...
            case R.id.img_bijia://比价
                if (TextUtils.isEmpty(compareUrl)) {
                    ToastUtils.getInstanc(GoodsDetailNativeAgentActivity.this).showToast("未找到同类商品~");
                } else {
                    Intent priva = new Intent(GoodsDetailNativeAgentActivity.this, MyWebViewActivity.class);
    ...
    private void insertFavorite() {
        ...
        try {
            ...
            params.put("userid", loginUserId);
            RequestInterface.goodsPrefix(GoodsDetailNativeAgentActivity.this, params, TAG, ReqConstance.I_GOODS_FAVORITE_INSERT, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    if (code == 0) {
                        imgCollection.setImageResource(R.mipmap.ic_goods_sc_red);
    ...
    private void deleteFavorite() {
        ...
        try {
            ...
            params.put("goodsId", goodsDetailBean.getGoodsId());
            params.put("userid", loginUserId);
            RequestInterface.goodsPrefix(GoodsDetailNativeAgentActivity.this, params, TAG, ReqConstance.I_GOODS_FAVORITE_DELETE, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    if (code == 0) {
                        imgCollection.setImageResource(R.mipmap.ic_goods_sc);
...
//            }
            ...
            RequestInterface.cartPrefix(GoodsDetailNativeAgentActivity.this, params, TAG, ReqConstance.I_CART_ADD, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    ToastUtils.getInstanc(GoodsDetailNativeAgentActivity.this).showToast(msg);
                    if (code == 0) {
    ...
    private void buyGoods(SkuListBean sku, int num, String memo) {
        ...
        if (isAgent) {//是Agent
            Intent intent = new Intent(GoodsDetailNativeAgentActivity.this, OrderXiaDanActivity.class);
...
//        finish();
    ...
    private void getDefaultAddress(String userId) {
        ...
        try {
            ...
            RequestInterface.userPrefix(GoodsDetailNativeAgentActivity.this, params, TAG + "ADDRESS", ReqConstance.I_DEFALUT_ADDREDSS_MONEY_CB, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    ModelLoading.getInstance(GoodsDetailNativeAgentActivity.this).closeLoading();
                    if (code == 0) {
                ...
                public void requestError(String s, int i) {
                    ModelLoading.getInstance(GoodsDetailNativeAgentActivity.this).closeLoading();
                    ToastUtils.getInstanc(GoodsDetailNativeAgentActivity.this).showToast(Constant.NET_ERROR);
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
...
//        webView.destroy();
    ...
    private void showSharePop() {
        ...
        View upView = LayoutInflater.from(GoodsDetailNativeAgentActivity.this).inflate(R.layout.popup_share_haibao, null);
        //测量View的宽高
        DensityUtils.measureWidthAndHeight(upView);
        popupWindow = new CommonPopupWindow.Builder(GoodsDetailNativeAgentActivity.this)
            ...
            case R.layout.popup_share://分享
                ...
                shareHB.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent=new Intent(GoodsDetailNativeAgentActivity.this,PosterActivity.class);
                        intent.putExtra("share_goods_id",goodsId);
                        startActivity(intent, ActivityOptions.makeSceneTransitionAnimation(GoodsDetailNativeAgentActivity.this).toBundle());
...
//                ToastUtils.getInstanc(MyCenterActivity.this).showToast("qq");
            ...
            case R.layout.popup_buy_agent://代理开通
                ...
                //商品价格
                double agentPrice = Double.valueOf(skuListBean.getVipPrice()) * skunum;
                ptv_pay_money.setText(String.valueOf(agentPrice));

                //须知
                tv_agent_xuzhi.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent vipRules = new Intent(GoodsDetailNativeAgentActivity.this, MyWebViewActivity.class);
                ...
                ptv_no_address.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(GoodsDetailNativeAgentActivity.this, MyAddressActivity.class);
                ...
                pimg_edit.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent edit = new Intent(GoodsDetailNativeAgentActivity.this, MyAddressActivity.class);
                ...
                img_wechat_pay.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        SPUtils.getInstance(GoodsDetailNativeAgentActivity.this).put(Constant.PAY_TYPE, "2");
...
// TODO Auto-generated method stub
    ...
    private void payOperation(String userId, final int payType) {
        ...
        try {
            ...
            object.put("skuNum", skunum);
            object.put("memo", skumemo);
            array.put(object);
...
//            params.put("vipTypeId", vipTypeId);
            ...
            RequestInterface.payPrefix(GoodsDetailNativeAgentActivity.this, params, TAG, ReqConstance.I_PAY_SHOPPING, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    ModelLoading.getInstance(GoodsDetailNativeAgentActivity.this).closeLoading();
                    if (code == 0) {
    ...
    private void aliPay(final String orderInfo) {
        Runnable payRunnable = new Runnable() {
            ...
            @Override
            public void run() {
                PayTask alipay = new PayTask(GoodsDetailNativeAgentActivity.this);
