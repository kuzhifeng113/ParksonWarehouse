 ...
 *  分类商品适配
 */
public class CategoryGoodsAdapterTwo extends RecyclerView.Adapter<CategoryGoodsAdapterTwo.MyViewHolder> {
    ...
    public CategoryGoodsAdapterTwo(Context context, List<CategoryGoodsBeanTwo.PageBean.ContentBean> dataList) {
