 ...
 *  分类商品适配
 */
public class CategoryGoodsAdapter extends RecyclerView.Adapter<CategoryGoodsAdapter.MyViewHolder> {
    private Context context;
    private List<CategoryGoodsBean.ContentBean> dataList;
    ...
    public CategoryGoodsAdapter(Context context, List<CategoryGoodsBean.ContentBean> dataList,boolean isVip) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        CategoryGoodsBean.ContentBean goodsListBean = dataList.get(position);
