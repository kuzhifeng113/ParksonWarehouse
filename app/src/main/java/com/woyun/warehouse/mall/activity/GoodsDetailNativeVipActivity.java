 ...
 * 商品详情(Vip   礼包)-原生
 */
public class GoodsDetailNativeVipActivity extends BaseActivity implements CommonPopupWindow.ViewInterface, WbShareCallback {
...
//                    iwxApi.sendReq(shareWxUrl(goodesWebUrl, shareTile, shareContent, 0, shareIconUrl));
    ...
    private Handler payHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (resultStatus.equals("9000")) {
                SPUtils.getInstance(GoodsDetailNativeVipActivity.this).put(Constant.USER_IS_AGENT, true);
                ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast("支付成功！！！");
                Intent agent = new Intent(GoodsDetailNativeVipActivity.this, MainActivity.class);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_goods_detail_native_vip);
        ButterKnife.bind(this);
        MyApplication.getInstance().addActivity(GoodsDetailNativeVipActivity.this);
        mContext = GoodsDetailNativeVipActivity.this;
        mIUiListener = new ShareQQListener();
        iwxApi = WXAPIFactory.createWXAPI(GoodsDetailNativeVipActivity.this, Constant.WX_APP_ID);
        iwxApi.registerApp(Constant.WX_APP_ID);
        mTencent = Tencent.createInstance(Constant.QQ_APP_ID, getApplicationContext());
        //微博
        shareHandler = new WbShareHandler(GoodsDetailNativeVipActivity.this);
...
//                    Log.e(TAG, "onAdded: unitPrice" +sku.getVipPrice());
    ...
    private void getData(int goodsID) {
        ...
        try {
            ...
            RequestInterface.goodsPrefix(GoodsDetailNativeVipActivity.this, params, TAG, ReqConstance.I_GOODS_DETAIL, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    ModelLoading.getInstance(GoodsDetailNativeVipActivity.this).closeLoading();
                    tokenTimeLimit(GoodsDetailNativeVipActivity.this, code);
                    if (code == 0) {
...
//                            Log.e(TAG, "requestSuccess: " + jsonResult);
                        ...
                        ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast(msg);
                    }
                }
                ...
                public void requestError(String s, int i) {
                    ...
                    ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast(s);
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void pasterData(GoodsDetailBean goodsDetailBean) {
        ...
        nativeContentAdapter = new NativeContentAdapter(GoodsDetailNativeVipActivity.this, contentListBeanList);
        recyclerView.setAdapter(nativeContentAdapter);

        nativeViewPageAdapter = new NativeViewPageAdapter(GoodsDetailNativeVipActivity.this, resListBeanList);
        ...
        nativeViewPageAdapter.setOnItemClickListener(new NativeViewPageAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int index) {
                ...
                startActivity(toLook, ActivityOptions.makeSceneTransitionAnimation(GoodsDetailNativeVipActivity.this).toBundle());
            }
        });
...
//                showSharePop();
            ...
            case R.id.img_bijia://比价
                if (TextUtils.isEmpty(compareUrl)) {
                    ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast("未找到同类商品~");
                } else {
                    Intent priva = new Intent(GoodsDetailNativeVipActivity.this, MyWebViewActivity.class);
    ...
    private void insertFavorite() {
        ...
        try {
            ...
            params.put("userid", loginUserId);
            RequestInterface.goodsPrefix(GoodsDetailNativeVipActivity.this, params, TAG, ReqConstance.I_GOODS_FAVORITE_INSERT, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    if (code == 0) {
                        imgCollection.setImageResource(R.mipmap.ic_goods_sc_red);
    ...
    private void deleteFavorite() {
        ...
        try {
            ...
            params.put("goodsId", goodsDetailBean.getGoodsId());
            params.put("userid", loginUserId);
            RequestInterface.goodsPrefix(GoodsDetailNativeVipActivity.this, params, TAG, ReqConstance.I_GOODS_FAVORITE_DELETE, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    if (code == 0) {
                        imgCollection.setImageResource(R.mipmap.ic_goods_sc);
...
//            }
            ...
            RequestInterface.cartPrefix(GoodsDetailNativeVipActivity.this, params, TAG, ReqConstance.I_CART_ADD, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast(msg);
                    if (code == 0) {
    ...
    private void buyGoods(SkuListBean sku, int num, String memo) {
        ...
        if (isVip) {//是vip
            Intent intent = new Intent(GoodsDetailNativeVipActivity.this, OrderXiaDanActivity.class);
            intent.putExtra("total_price", totalPrice);
            intent.putExtra("select_data", (Serializable) selectList);
            startActivity(intent);
        } else {
            getDefaultAddress(loginUserId, 2, sku, num, memo);
        }
...
//        finish();
     ...
     *
     * @param userId
     * @param skuListBean sku
     * @param quantity    数量
     * @param resultMemo  描述  ”红色，L码”
     * @type 2 购买会员弹窗
     */
    private void getDefaultAddress(String userId, final int type, SkuListBean skuListBean, int quantity, String resultMemo) {
        ModelLoading.getInstance(GoodsDetailNativeVipActivity.this).showLoading("", true);
        //获取数据
        try {
            JSONObject params = new JSONObject();
            params.put("userid", userId);
            RequestInterface.userPrefix(GoodsDetailNativeVipActivity.this, params, TAG + "ADDRESS", ReqConstance.I_DEFALUT_ADDREDSS_MONEY_CB, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    ModelLoading.getInstance(GoodsDetailNativeVipActivity.this).closeLoading();
                    if (code == 0) {
                        try {
                            ...
                            showDialogBuy(type, skuListBean, quantity, resultMemo);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                    } else {
                ...
                public void requestError(String s, int i) {
                    ModelLoading.getInstance(GoodsDetailNativeVipActivity.this).closeLoading();
                    ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast(Constant.NET_ERROR);
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
...
// TODO Auto-generated method stub
     ...
     * @param type
     */
    private void showDialogBuy(int type, SkuListBean skuListBean, int quantity, String memo) {
        final BuyVipDialog view = new BuyVipDialog(GoodsDetailNativeVipActivity.this);
        view.show();
        ...
        tv_vip_xuzhi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vipRules = new Intent(GoodsDetailNativeVipActivity.this, MyWebViewActivity.class);
        ...
        ptv_no_address.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(GoodsDetailNativeVipActivity.this, MyAddressActivity.class);
        ...
        pimg_edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent edit = new Intent(GoodsDetailNativeVipActivity.this, MyAddressActivity.class);
        ...
        img_wechat_pay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(ptv_name.getText().toString())) {
                    ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast("还未添加地址哦");
                    return;
                }
                if (TextUtils.isEmpty(edit_invide_code.getText().toString())) {
                    ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast("请输入邀请码");
                    return;
                }
                if (edit_invide_code.getText().toString().length() != 11) {
                    ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast("请输入正确邀请码");
                    return;
                }
                view.dismiss();
                SPUtils.getInstance(GoodsDetailNativeVipActivity.this).put(Constant.PAY_TYPE, "1");
                payOperation(loginUserId, 1, edit_invide_code.getText().toString().trim(), type, skuListBean, quantity, memo);
            }
        });
     ...
     * @param skuListBean sku
     * @param quantity    数量
     * @param memo        SKU的属性拼接 ，如 memo=”红色，L码”
     */
    private void payOperation(String userId, final int payType, String inviteCode, int type, SkuListBean skuListBean, int quantity, String memo) {
        ModelLoading.getInstance(GoodsDetailNativeVipActivity.this).showLoading("", true);
        //获取数据
        try {
            JSONObject params = new JSONObject();
            ...
            object.put("goodsId", goodsDetailBean.getGoodsId());
            object.put("goodsImage", goodsDetailBean.getImage());
            object.put("goodsName", goodsDetailBean.getName());
            object.put("skuName", skuListBean.getSkuName());
            object.put("unitPrice", skuListBean.getVipPrice());
            object.put("userid", userId);
            object.put("skuId", skuListBean.getSkuId());
            object.put("skuImage", skuListBean.getImage());
            object.put("skuNum", quantity);
...
//            params.put("vipTypeId", vipTypeId);
            ...
            if (isVip) {
                params.put("tradeType", Constant.PAY_TYPE_AGENT);//交易类型：1vip购买，2代理购买会员，3商城订单
            } else {
            ...
            RequestInterface.payPrefix(GoodsDetailNativeVipActivity.this, params, TAG, ReqConstance.I_PAY_SHOPPING, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    ModelLoading.getInstance(GoodsDetailNativeVipActivity.this).closeLoading();
                    if (code == 0) {
    ...
    private void aliPay(final String orderInfo) {
        Runnable payRunnable = new Runnable() {
            ...
            @Override
            public void run() {
                PayTask alipay = new PayTask(GoodsDetailNativeVipActivity.this);
    ...
    private void showInvoiceDialog() {
        ...
        invoiceDialog = new InvoiceDialog(GoodsDetailNativeVipActivity.this);
        invoiceDialog.show();
            ...
            public void onClick(View v) {
                if (ckboxPersonal.isChecked()) {//个人
                    if (TextUtils.isEmpty(editName.getText().toString())) {
                        ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast("名字不能为空！");
                        return;
                    }
                    if (TextUtils.isEmpty(editEMail.getText().toString())) {
                        ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast("邮箱不能为空！");
                        return;
                    }
                    if (isEditInvoice) {//修改
                ...
                if (ckboxUnit.isChecked()) {//单位
                    if (TextUtils.isEmpty(editName.getText().toString())) {
                        ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast("单位名称不能为空！");
                        return;
                    }
                    if (TextUtils.isEmpty(editCode.getText().toString())) {
                        ToastUtils.getInstanc(GoodsDetailNativeVipActivity.this).showToast("纳税人识别号不能为空！");
                        return;
                    }
    ...
    private void updateInvonice(int invoId, String userId, String invoiceName, String taxNumber, int type, String email) {
        ...
        try {
            ...
            RequestInterface.userPrefix(GoodsDetailNativeVipActivity.this, params, TAG, ReqConstance.I_USER_INVOICE_UPDATE, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    ModelLoading.getInstance(GoodsDetailNativeVipActivity.this).closeLoading();
                    if (code == 0) {
...
//                        ToastUtils.getInstanc(OrderXiaDanActivity.this).showToast(msg);
    ...
    private void addInvonice(String userId, String invoiceName, String taxNumber, int type, String email) {
        ...
        try {
            ...
            RequestInterface.userPrefix(GoodsDetailNativeVipActivity.this, params, TAG, ReqConstance.I_USER_INVOICE_INSERT, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    ModelLoading.getInstance(GoodsDetailNativeVipActivity.this).closeLoading();
                    if (code == 0) {
