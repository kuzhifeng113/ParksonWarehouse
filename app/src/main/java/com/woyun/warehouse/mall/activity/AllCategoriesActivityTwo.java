...
import com.woyun.warehouse.vote.fragment.HostFragmentThree;
 ...
 * 全部分类
 */
public class AllCategoriesActivityTwo extends BaseActivity {
...
//        initData();
    ...
    private void getCategoryData(){
        ...
        try {
            ...
            RequestInterface.goodsPrefix(AllCategoriesActivityTwo.this, params, TAG, ReqConstance.I_GOODS_CATEGORY, 1, new HSRequestCallBackInterface() {
                @Override
                public void requestSuccess(int funcID, int reqID, String reqToken, String msg, int code, JSONArray jsonArray) {
                    if (code == 0) {
                        ...
                        ToastUtils.getInstanc(AllCategoriesActivityTwo.this).showToast(msg);
                    }
                }

                @Override
                public void requestError(String s, int i) {
                    ToastUtils.getInstanc(AllCategoriesActivityTwo.this).showToast(s);
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public Fragment  getfragment(int position){
        ...
        if (fg == null) {
            fg = HostFragmentThree.getInitUrl(listTiles.get(position).getCategoryId());
            arrays[position] = fg;
        }
        return fg;
    }
